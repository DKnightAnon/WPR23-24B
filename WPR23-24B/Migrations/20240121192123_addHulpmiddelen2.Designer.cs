...
namespace WPR23_24B.Migrations
{
    ...
    [Migration("20240121192123_addHulpmiddelen2")]
    partial class addHulpmiddelen2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WPR23_24B.Models.Medisch.ErvaringsdeskundigeHulpmiddel", b =>
                {
                    b.Property<string>("ErvaringsdeskundigeId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("WPR23_24B.Models.Medisch.Hulpmiddel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 5,
                            Name = "Aangepast Toetsenbord"
                        },
                        new
                        {
                            Id = 6,
                            Name = "Muisaanpassingen"
                        },
                        new
                        {
                            Id = 7,
            ...
            modelBuilder.Entity("WPR23_24B.Models.Medisch.ErvaringsdeskundigeHulpmiddel", b =>
                {
                    b.HasOne("WPR23_24B.Models.Authenticatie.Ervaringsdeskundige", "Ervaringsdeskundige")
                        .WithMany("ErvaringsdeskundigeHulpmiddelen")
                        .HasForeignKey("ErvaringsdeskundigeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WPR23_24B.Models.Medisch.Hulpmiddel", "Hulpmiddel")
                        .WithMany("ErvaringsdeskundigeHulpmiddelen")
                        .HasForeignKey("HulpmiddelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WPR23_24B.Models.Medisch.Hulpmiddel", b =>
                {
                    b.Navigation("ErvaringsdeskundigeHulpmiddelen");

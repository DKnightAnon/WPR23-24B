...
namespace WPR23_24B.Migrations
{
    ...
    [Migration("20231231183405_AlterChatBerichtChangeIdToGUID")]
    partial class AlterChatBerichtChangeIdToGUID
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WPR23_24B.Chat.Models.ChatDeelnemer", b =>
                {
            ...
            modelBuilder.Entity("WPR23_24B.Chat.Models.ChatDeelnemer", b =>
                {
                    ...
                    b.HasOne("WPR23_24B.Chat.Models.ChatRoom", "Gesprek")
                        .WithMany()
                        .HasForeignKey("GesprekId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WPR23_24B.Chat.Models.ChatRoom", null)
                        .WithMany()
